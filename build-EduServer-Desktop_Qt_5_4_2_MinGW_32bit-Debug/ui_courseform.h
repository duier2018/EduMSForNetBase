...
public:
    ...
    void setupUi(QWidget *CourseForm)
    {
        if (CourseForm->objectName().isEmpty())
            CourseForm->setObjectName(QStringLiteral("CourseForm"));
        CourseForm->resize(540, 450);
        CourseForm->setStyleSheet(QStringLiteral(""));
        gridLayout_3 = new QGridLayout(CourseForm);
        gridLayout_3->setObjectName(QStringLiteral("gridLayout_3"));
        groupBox_4 = new QGroupBox(CourseForm);
        ...
        groupBox = new QGroupBox(CourseForm);
        ...
        groupBox_2 = new QGroupBox(CourseForm);
        ...
        gridLayout->addWidget(le_pswd, 1, 1, 1, 1);
        ...
        retranslateUi(CourseForm);

        QMetaObject::connectSlotsByName(CourseForm);
    } // setupUi

    void retranslateUi(QWidget *CourseForm)
    {
        CourseForm->setWindowTitle(QApplication::translate("CourseForm", "Form", 0));
        groupBox_4->setTitle(QApplication::translate("CourseForm", "\346\235\241\344\273\266\346\237\245\350\257\242\357\274\232", 0));
        label->setText(QApplication::translate("CourseForm", "\351\200\211\346\213\251\357\274\232", 0));
        cb_condition->clear();
        cb_condition->insertItems(0, QStringList()
         << QApplication::translate("CourseForm", "\346\227\240\346\235\241\344\273\266", 0)
         << QApplication::translate("CourseForm", "\350\257\276\347\250\213\345\217\267", 0)
         << QApplication::translate("CourseForm", "\345\220\215\347\247\260", 0)
         << QApplication::translate("CourseForm", "\347\261\273\345\210\253", 0)
        );
        label_6->setText(QApplication::translate("CourseForm", "\346\235\241\344\273\266\357\274\232", 0));
        pb_search->setText(QApplication::translate("CourseForm", "\346\220\234\347\264\242", 0));
        groupBox->setTitle(QApplication::translate("CourseForm", "\346\237\245\350\257\242\347\273\223\346\236\234\357\274\232", 0));
        groupBox_2->setTitle(QApplication::translate("CourseForm", "\347\233\270\345\205\263\346\223\215\344\275\234\357\274\232", 0));
        label_4->setText(QApplication::translate("CourseForm", "\346\225\231  \345\256\244\357\274\232", 0));
        label_2->setText(QApplication::translate("CourseForm", "\347\217\255\347\272\247\345\217\267\357\274\232", 0));
        label_3->setText(QApplication::translate("CourseForm", "\345\220\215\347\247\260\357\274\232", 0));
        label_5->setText(QApplication::translate("CourseForm", "\344\272\272\346\225\260\357\274\232", 0));
        pb_modify->setText(QApplication::translate("CourseForm", "\344\277\256\346\224\271", 0));
        pb_delete->setText(QApplication::translate("CourseForm", "\345\210\240\351\231\244", 0));
        pb_cancel->setText(QApplication::translate("CourseForm", "\345\217\226\346\266\210", 0));
        pb_add->setText(QApplication::translate("CourseForm", "\346\226\260\345\242\236", 0));
        pb_save->setText(QApplication::translate("CourseForm", "\344\277\235\345\255\230", 0));
    } // retranslateUi

};

namespace Ui {
    class CourseForm: public Ui_CourseForm {};
} // namespace Ui
