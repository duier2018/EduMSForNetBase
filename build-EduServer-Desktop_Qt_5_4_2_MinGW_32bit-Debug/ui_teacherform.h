...
public:
    ...
    void setupUi(QWidget *TeacherForm)
    {
        ...
        TeacherForm->resize(540, 450);
        gridLayout_3 = new QGridLayout(TeacherForm);
        gridLayout_3->setObjectName(QStringLiteral("gridLayout_3"));
        groupBox_4 = new QGroupBox(TeacherForm);
        ...
        groupBox = new QGroupBox(TeacherForm);
        ...
        groupBox_2 = new QGroupBox(TeacherForm);
        ...
        le_dept = new QLineEdit(groupBox_2);
        le_dept->setObjectName(QStringLiteral("le_dept"));
        le_dept->setEnabled(false);
        le_dept->setClearButtonEnabled(true);

        gridLayout->addWidget(le_dept, 1, 1, 1, 1);
        ...
        le_post = new QLineEdit(groupBox_2);
        le_post->setObjectName(QStringLiteral("le_post"));
        le_post->setEnabled(false);
        le_post->setClearButtonEnabled(true);

        gridLayout->addWidget(le_post, 1, 3, 1, 1);
    ...
    void retranslateUi(QWidget *TeacherForm)
    {
        ...
        groupBox_4->setTitle(QApplication::translate("TeacherForm", "\346\235\241\344\273\266\346\237\245\350\257\242\357\274\232", 0));
        label->setText(QApplication::translate("TeacherForm", "\351\200\211\346\213\251\357\274\232", 0));
        cb_condition->clear();
        cb_condition->insertItems(0, QStringList()
         << QApplication::translate("TeacherForm", "\346\227\240\346\235\241\344\273\266", 0)
         << QApplication::translate("TeacherForm", "\345\267\245\345\217\267", 0)
         << QApplication::translate("TeacherForm", "\345\247\223\345\220\215", 0)
         << QApplication::translate("TeacherForm", "\351\203\250\351\227\250", 0)
         << QApplication::translate("TeacherForm", "\350\201\214\347\247\260", 0)
        );
        label_6->setText(QApplication::translate("TeacherForm", "\346\235\241\344\273\266\357\274\232", 0));
        pb_search->setText(QApplication::translate("TeacherForm", "\346\220\234\347\264\242", 0));
        groupBox->setTitle(QApplication::translate("TeacherForm", "\346\237\245\350\257\242\347\273\223\346\236\234\357\274\232", 0));
        groupBox_2->setTitle(QApplication::translate("TeacherForm", "\347\233\270\345\205\263\346\223\215\344\275\234\357\274\232", 0));
        label_4->setText(QApplication::translate("TeacherForm", "\351\203\250\351\227\250\357\274\232", 0));
        label_2->setText(QApplication::translate("TeacherForm", "\345\267\245\345\217\267\357\274\232", 0));
        label_3->setText(QApplication::translate("TeacherForm", "\345\247\223\345\220\215\357\274\232", 0));
        label_5->setText(QApplication::translate("TeacherForm", "\350\201\214\345\212\241\357\274\232", 0));
        pb_modify->setText(QApplication::translate("TeacherForm", "\344\277\256\346\224\271", 0));
        pb_delete->setText(QApplication::translate("TeacherForm", "\345\210\240\351\231\244", 0));
        pb_cancel->setText(QApplication::translate("TeacherForm", "\345\217\226\346\266\210", 0));
        pb_add->setText(QApplication::translate("TeacherForm", "\346\226\260\345\242\236", 0));
        pb_save->setText(QApplication::translate("TeacherForm", "\344\277\235\345\255\230", 0));
    } // retranslateUi
