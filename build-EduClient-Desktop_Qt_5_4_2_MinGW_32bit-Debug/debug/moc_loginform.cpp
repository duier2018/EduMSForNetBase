...
#include "../../EduClient/sublogin/loginform.h"
...
QT_MOC_LITERAL(1, 10, 15), // "signalUserLogin"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 2), // "id"
QT_MOC_LITERAL(4, 30, 4), // "pswd"
QT_MOC_LITERAL(5, 35, 16), // "signalUserLogout"
QT_MOC_LITERAL(6, 52, 19) // "on_pb_login_clicked"

    },
    "LoginForm\0signalUserLogin\0\0id\0pswd\0"
    "signalUserLogout\0on_pb_login_clicked"
};
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginForm::signalUserLogin)) {
                *result = 0;
            }
        }
        {
            typedef void (LoginForm::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginForm::signalUserLogout)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void LoginForm::signalUserLogin(QString _t1, QString _t2)
{
...
// SIGNAL 1
void LoginForm::signalUserLogout()
{
